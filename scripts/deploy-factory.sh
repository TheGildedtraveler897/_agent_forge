...
echo "  2. ./scripts/bootstrap-project.sh --name reddit-archive"
echo "  3. ./scripts/sync-claude-adapters.sh --project reddit-archive --projects-root ${PROJECTS_ROOT} --claude-home ${CLAUDE_HOME}"
echo "  4. ./scripts/sync-codex-skills.sh --project reddit-archive --target ${CODEX_HOME}/skills"
